...
- ### [(https://youtu.be/5RAYwjRTQak)](https://www.youtube.com/watch?v=5RAYwjRTQak)
...
- Connected to the vitual machine using remote desktop (RDP) 1
...
![image](<img width="1106" height="593" alt="image" src="https://github.com/user-attachments/assets/a40a335b-617e-4b1b-bfe0-abe00d430a06" />
...
Action:
- copy the public ip adress of your virtual machine
- After the VM is running → Click the windows icon and search RDP
- paste the ip adress
